...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'showAds': 'Show ads',
    'showAdsDesc': 'Free experience shows ads. Turn off for $19.99 one-time.',
    'goAdFree': 'Go ad-free',
    ...
    'goAdFreeDesc': 'To stop seeing ads in free classes and across the app, a one-time payment of $19.99 is required. You will not see ads again after this purchase.',
  ...
  es: {
    ...
    'showAdsDesc': 'La experiencia gratuita muestra anuncios. Desactívalos por 19,99 $ único.',
    ...
    'goAdFreeDesc': 'Para dejar de ver anuncios en clases gratuitas y en la aplicación, se requiere un pago único de 19,99 $. No volverás a ver anuncios después de esta compra.',
    'oneTimePayment': 'Pago único',
    'noSubscription': 'Sin suscripción. Paga una vez, disfruta sin anuncios para siempre.',
    'processing': 'Procesando...',
    'payAmount': 'Pagar 19,99 $',
