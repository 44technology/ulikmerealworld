...
export interface Post {
  ...
  venueId?: string;
  meetupId?: string;
  /** When set, post appears in that community's Posts tab */
  communityId?: string;
  createdAt: string;
  user: {
    id: string;
...
export const usePosts = (venueId?: string, meetupId?: string, communityId?: string) => {
  return useQuery({
    queryKey: ['posts', venueId, meetupId, communityId],
    queryFn: async () => {
