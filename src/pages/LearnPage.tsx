...
import { Search, Plus, BookOpen, Users, MapPin, MessageSquare, DollarSign, Clock, ArrowLeft } from 'lucide-react';
        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <h1 className="text-xl font-bold text-foreground truncate">Learn</h1>
            </div>
            <motion.button
