                  ...
                  shouldRevealDetails(selectedItem) ? (
                    <>
                      ...
                      <div className="space-y-2 mb-6 text-left">
                        {/* Host/Creator - Blur */}
                        {(selectedItem.instructor || selectedItem.creator || (selectedItem as any).host) && (
                          <div className="flex items-center gap-3 p-3 rounded-xl bg-muted">
                            <Users className="w-5 h-5 text-primary" />
                            <span className="text-foreground text-sm blur-sm select-none">
                              {(selectedItem as any).host?.name || selectedItem.instructor?.displayName || selectedItem.creator?.displayName || 'Host'}
                            </span>
                          </div>
                        )}
