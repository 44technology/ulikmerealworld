...
import { SPONSOR_STORIES, SPONSOR_POSTS } from '@/constants/sponsorAds';
  ...
  return (
    <AppLayout>
      ...
      <div className="pb-4 space-y-4">
        {postsWithSponsors.map((post: any) => {
              ...
              >
                <div className="flex items-center justify-between px-4 py-3">
                  <div className="flex items-center gap-3">
                    <UserAvatar src={post.avatar} alt={post.name} size="md" />
                    <div>
                      <p className="font-semibold text-foreground text-sm">{post.name}</p>
                      <span className="text-xs text-amber-600 dark:text-amber-400">Sponsored</span>
                    </div>
                  </div>
